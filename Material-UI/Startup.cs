...
namespace React.Sample.Webpack.CoreMvc
{
	public class Startup
	{
		...
		{
			// For removing the services.BuildServiceProvider warning
			// https://stackoverflow.com/questions/58999401/calling-buildserviceprovider-from-application-code-results-in-copy-of-singleto
			IServiceProvider applicationService = app.ApplicationServices;
